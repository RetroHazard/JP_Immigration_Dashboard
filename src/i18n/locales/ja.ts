...
export const ja: Dictionary = {
  ...
  'policy.eventsShow': '政策イベントを表示',
  'policy.eventsHide': '政策イベントを非表示',
  'policy.ssw2019.title': '特定技能の創設',
  'policy.ssw2019.description': '人手不足分野向けの在留資格。同じ日に出入国在留管理庁が発足しました。',
  'policy.covidClosure.title': 'コロナ禍の入国制限',
  'policy.covidClosure.description': '感染拡大に伴い、上陸拒否の対象地域が世界の大半に広がりました。',
  'policy.covidSuspension.title': '全世界からの新規入国を停止',
  'policy.covidSuspension.description': '12月下旬以降、査証の有無にかかわらず外国人の新規入国が止まりました。',
  'policy.covidOmicron.title': 'オミクロン株で再び停止',
  'policy.covidOmicron.description': '11月8日に再開した新規入国が、3週間後に再び停止されました。',
  'policy.covidResume.title': '留学生・就労者の入国を再開',
  'policy.covidResume.description': '就労・留学・商用の新規入国が、1日あたりの上限付きで再開しました。',
  'policy.covidVisaFree.title': 'ビザなし渡航が復活',
  'policy.covidVisaFree.description': '査証免除が再開され、1日あたりの入国者数の上限も撤廃されました。',
  'policy.covidCoe.title': '認定証明書の有効期間を延長',
  'policy.covidCoe.description': '入国できずにいた在留資格認定証明書は、3か月を超えて有効とされました。',
  'policy.covidEnd.title': '水際対策の終了',
  'policy.covidEnd.description': '検査と接種証明の確認が終わり、感染症法上の位置づけも5類になりました。',
