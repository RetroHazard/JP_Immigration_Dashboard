...
export const it: Dictionary = {
  ...
  'charts.statuses.aria': 'Grafico sunburst dei residenti per gruppo di status di residenza e singolo status',
  ...
  'residents.populationShare': 'Quota della popolazione',
  'residents.populationShare.short': 'Quota di pop.',
  'residents.populationShareOf': 'della popolazione del Giappone ({population} persone)',
  ...
  'residents.topStatus.short': 'Status princ.',
  ...
  'residents.stackByGroup': 'Per finalità di soggiorno',
  'residents.stackByRegion': 'Per regione del mondo',
  'residents.stackByNationality': 'Per nazionalità',
  'residents.growthTotal': 'Totale',
  'residents.viewAbsolute': 'Conteggi',
  'residents.viewIndexed': 'Crescita (indicizzata)',
  'residents.indexedTooltip': '×{multiple}',
  'residents.flowsValueUnit': 'residenti',
