...
export const tl: Dictionary = {
  ...
  'charts.share.description': 'Kung saan isinumite ang mga aplikasyon: ang bahagi ng bawat tanggapan sa kabuuang natanggap.',
  ...
  'charts.mix.description': 'Lahat ng aplikasyon ayon sa uri at tanggapan — i-click ang isang kategorya para mag-zoom sa breakdown nito.',
  ...
  'charts.efficiency.aria': 'Mga tanggapan na inayos ayon sa rate ng pagkumpleto, may dami ng natanggap bilang bigat ng stem',
  'charts.map.label': 'Rehiyonal na Mapa',
  'charts.map.description': 'Mga service area ng tanggapan at densidad ng populasyon, kasama ang lokasyon ng mga tanggapan at paliparan.',
  ...
  'map.resetView': 'I-reset ang view',
