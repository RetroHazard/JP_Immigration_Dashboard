...
export const ko: Dictionary = {
  ...
  'estimator.formula.step1': '처리 능력 기준',
  'estimator.formula.step2': '신청 시점의 대기열',
  'estimator.formula.step3': '신청 이후 처리량',
  'estimator.formula.step4': '대기 순번과 남은 일수',
  'estimator.formula.step5': '완료 일수와 오차 범위',
  ...
  'estimator.formula.var.sigmaD.description': '표본 기간에 포함된 달력 일수를 달마다 더한 값입니다.',
  'estimator.formula.var.rProc.title': '처리 속도',
  'estimator.formula.var.rProc.description': '표본 기간 전체에서 하루 평균 처리된 신청 건수입니다.',
  'estimator.formula.var.rNew.title': '접수 속도',
  ...
  'estimator.formula.var.cPrev.description':
    '신청한 달이 시작될 때 아직 대기 중이던 신청 건수입니다. 직전 달 수치가 공표되어 있으면 그대로 쓰고, 없으면 수치가 있는 가장 최근 달부터 한 달씩 밀어 올려 추정합니다.',
  'estimator.formula.var.nMonth.title': '해당 월 접수',
  'estimator.formula.var.nMonth.description': '신청한 달 전체에 걸쳐 접수된 신청 건수입니다.',
  ...
  'estimator.formula.var.pAfter.title': '이후 달 처리',
  'estimator.formula.var.pAfter.description': '신청한 달보다 뒤에 오는, 공표된 각 달에 처리된 신청 건수입니다.',
  'estimator.formula.var.tApp.title': '신청 후 경과일',
  'estimator.formula.var.tApp.description': '신청일부터 오늘까지의 달력 일수입니다.',
  'estimator.formula.var.tData.title': '최신 자료 후 경과일',
  'estimator.formula.var.tData.description': '가장 최근에 공표된 달의 마지막 날부터 오늘까지의 달력 일수입니다.',
  'estimator.formula.var.cProc.title': '확정 처리량',
  'estimator.formula.var.cProc.description': '신청 이후 처리된 건수 가운데 공표된 수치로 이미 확인되는 분량입니다.',
  'estimator.formula.var.eProc.title': '추정 처리량',
  ...
  'policy.eventsShow': '정책 이벤트 표시',
  'policy.eventsHide': '정책 이벤트 숨기기',
  'policy.ssw2019.title': '특정기능 신설',
  'policy.ssw2019.description': '인력 부족 분야를 위한 체류자격. 같은 날 출입국재류관리청이 출범했습니다.',
  'policy.covidClosure.title': '코로나19 입국 제한',
  'policy.covidClosure.description': '감염 확산에 따라 상륙 거부 대상 지역이 세계 대부분으로 확대되었습니다.',
  'policy.covidSuspension.title': '전 세계 신규 입국 정지',
  'policy.covidSuspension.description': '12월 말부터 사증 소지 여부와 관계없이 외국인의 신규 입국이 멈췄습니다.',
  'policy.covidOmicron.title': '오미크론으로 재차 중단',
  'policy.covidOmicron.description': '11월 8일 재개된 신규 입국이 3주 만에 다시 정지되었습니다.',
  'policy.covidResume.title': '유학생·취업자 입국 재개',
  'policy.covidResume.description': '취업·유학·상용 목적의 신규 입국이 1일 상한을 두고 재개되었습니다.',
  'policy.covidVisaFree.title': '무사증 여행 재개',
  'policy.covidVisaFree.description': '사증 면제가 부활하고 1일 입국자 상한도 폐지되었습니다.',
  'policy.covidCoe.title': '인정증명서 유효기간 연장',
  'policy.covidCoe.description': '입국하지 못한 체류자격인정증명서는 3개월을 넘겨 유효한 것으로 인정되었습니다.',
  'policy.covidEnd.title': '방역 국경 조치 종료',
  'policy.covidEnd.description': '검사와 접종 증명 확인이 끝나고 코로나19는 5류로 분류되었습니다.',
